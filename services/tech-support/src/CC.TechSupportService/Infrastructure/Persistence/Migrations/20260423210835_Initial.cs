        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ticket_attachment_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_files_details", x => x.id);
                    table.ForeignKey(
                        name: "fk_files_details_ticket_attachments_ticket_attachment_id",
                        column: x => x.ticket_attachment_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_files_details_ticket_attachment_id",
                schema: "tech_support",
                table: "files_details",
                column: "ticket_attachment_id");
        }
