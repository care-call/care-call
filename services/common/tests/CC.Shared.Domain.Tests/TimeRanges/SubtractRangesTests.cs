...
public sealed class SubtractRangesTests
{
    ...
    {
        var original = new[] { DateTimeRange.Range("08:00", "12:00") };
        var subtract = DateTimeRange.Range("14:00", "16:00");

        var result = original.SubtractRanges(subtract);
    ...
    {
        var original = new[] { DateTimeRange.Range("08:00", "16:00") };
    ...
    {
        var original = new[] { DateTimeRange.Range("08:00", "18:00") };
        var subtract = DateTimeRange.Range("12:00", "14:00");

        var result = original.SubtractRanges(subtract).ToList();
